...
// Obtengo todos los videogames por nombre: 
const getVideogames = async (name) => {

    // Obtengo los datos de videogames de la API:
    ...
    //    // Recupero datos de varias páginas:
    ...
    // Obtengo los datos de videogames de la BD:
    ...
    // Uno los datos de videogames de la BD y la API:
