...
import { postVideogame, getGenres } from '../../Redux/Action/Action';
...
export default function VideogameCreate() {
    const dispatch = useDispatch();// trae datos del estado global del reducer
    ...
    function handleSubmit(e) {
        ...
        if (input.rating < 0 || input.rating > 5) {
            return alert('The rating must be a number between 0-5')
        }
        setErrors(
            validate({
                ...input,
    ...
    function handleDeleteGenre(e) {
        setInput({
            ...input, // traigo el estado anterior
