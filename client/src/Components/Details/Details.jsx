...
export default function Details() {
    ...
    const {id} = useParams() // rutas dinámicas, podemos acceder a cualquier parámetro de ruta de una ruta declarada con su componente asociado usando el hook useParams.
    const dispatch = useDispatch() // traigo los datos del estado global del reducer
